...
const TOOL_PHASES = {
  ...
  search_perplexity_web: ["research", "搜尋最新公開資訊"],
  search_instagram_public_hashtag: ["research", "搜尋 Instagram 公開標籤"],
  search_instagram_public_account: ["research", "讀取公開專業帳號"],
  search_tku_public_info: ["research", "查詢淡江官方資訊"],
  fetch_tku_public_source: ["research", "讀取官方來源"],
  list_tku_public_sources: ["research", "列出淡江公開來源"],
