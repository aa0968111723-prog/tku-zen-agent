...
def test_exposed_tool_count_stays_small_with_activity_tools(twenty_mock_tools):
    # The public-source, Perplexity and visual-library capabilities add six
    # first-class tools to the original baseline: 32 production tools + 20
    # temporary mocks in this fixture.
